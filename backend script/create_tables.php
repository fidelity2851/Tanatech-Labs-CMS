...
//create post table
$post_tb = "CREATE TABLE IF NOT EXISTS post (post_id INT NOT NULL AUTO_INCREMENT, post_title VARCHAR(400), slug_url VARCHAR(200), post_summary TEXT, page_content TEXT, author VARCHAR(100), category VARCHAR(100), sub_category VARCHAR(100), tags VARCHAR(300), crt_date TIMESTAMP(6), up_date TIMESTAMP(6), PRIMARY KEY(post_id))";
...
$category_tb = "CREATE TABLE IF NOT EXISTS category (category_id INT NOT NULL AUTO_INCREMENT, cate_name VARCHAR(200), category_url VARCHAR(500), icon BOOLEAN(1), crt_date DATE(6), up_date CURRENT_DATE(6), PRIMARY KEY (category_id))";
...
//create banner table
$banner_tb = "CREATE TABLE IF NOT EXISTS banner (banner_id INT NOT NULL AUTO_INCREMENT, webpage VARCHAR(200), banner_img VARCHAR(500), banner_header VARCHAR(100), banner_description TEXT, crt_date DATE(6), up_date CURRENT_DATE(6), PRIMARY KEY (banner_id))";
